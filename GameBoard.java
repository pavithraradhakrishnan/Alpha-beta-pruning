...
public class GameBoard 
{
	...
	{//System.out.println("this get current turn " + this.getCurrentTurn);
    ...
    public int getCurrentTurn() 
    {
    	...
    	//if(gamemode.equalsIgnoreCase("interactive") && gamemode.equalsIgnoreCase("human-next"))
    	//{
    		//return 2;
    	//}
    	//else if(gamemode.equalsIgnoreCase("interactive") && gamemode.equalsIgnoreCase("computer-next"))
    	//{
    		//return 1;
    	//}
    	//else
	...
	if ( !( column >= 0 && column <=7 ) ) {
		...
		//System.out.println("this.playBoard[0][" + "column]" +"has" + this.playBoard[0][column]);
		//System.out.println("comes to second if");
	    return false;
	} else {
